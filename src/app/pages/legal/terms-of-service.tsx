        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Card className="mb-8">
                <CardContent className="p-6 prose prose-invert max-w-none">
                    <h3>1. Giới thiệu</h3>
                    <p>Chào mừng bạn đến với Quantax. Khi truy cập và sử dụng dịch vụ của chúng tôi, bạn đồng ý tuân thủ các điều khoản này.</p>

                    <h3>2. Dịch vụ Giao dịch</h3>
                    <p>Quantax cung cấp nền tảng giao dịch quyền chọn nhị phân (Binary Options). Chúng tôi không giữ tiền của người dùng và không can thiệp vào kết quả.</p>
