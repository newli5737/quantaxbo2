        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Card className="mb-8 border-green-500/20">
                <CardContent className="p-6 prose prose-invert max-w-none">
                    ...
                    <p>Quantax cam kết bảo mật thông tin cá nhân của bạn theo tiêu chuẩn cao nhất. Chúng tôi không chia sẻ thông tin với bên thứ ba.</p>
                    ...
                    <p>Nếu bạn phát hiện bất kỳ lỗ hổng bảo mật nào, vui lòng liên hệ với chúng tôi qua email support@quantax.example.com.</p>
                </CardContent>
            </Card>
        </div>
    );
