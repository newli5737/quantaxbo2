        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Card className="mb-8 border-red-500/20">
                <CardContent className="p-6 prose prose-invert max-w-none">
                    ...
                    <p>Các thông tin, phân tích, và tín hiệu trên Quantax chỉ mang tính chất tham khảo và giáo dục. Chúng tôi không đưa ra lời khuyên đầu tư tài chính.</p>

                    <h3>4. Trách nhiệm người dùng</h3>
                    <p>Bạn hoàn toàn chịu trách nhiệm về các quyết định giao dịch của mình. Quantax không chịu trách nhiệm cho bất kỳ tổn thất nào phát sinh từ việc sử dụng nền tảng.</p>
